	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<a href="images/menu-2.jpg" class="image-popup"><img src="<?php echo IMAGEURL; ?>/<?php echo $singleProduct->image; ?>" class="img-fluid" alt="Colorlib Template"></a>
			</div>
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				<h3><?php echo $singleProduct->name; ?></h3>
				<p class="price"><span>Rs <?php echo $singleProduct->price; ?></span></p>
				<p>
				...
				<form method="POST" action="product-single.php?id=<?php echo $id; ?>">
					...
					<?php if (isset($_SESSION['user_id'])) : ?>
						...
						<?php if ($rowCount  > 0) : ?>
							<button name="submit" type="submit" class="btn btn-primary py-3 px-5">Added to Cart</button>

						<?php else : ?>
							<button name="submit" type="submit" class="btn btn-primary py-3 px-5">Add to Cart</button>
							<!--<button style="margin-top: -335px; margin-left:632px; height : 65 px;" name="submit" type="submit" class="btn btn-primary py-3 px-5">Add to Cart</button>-->

						<?php endif; ?>
					<?php else : ?>
						<a href="<?php echo APPURL; ?>/auth/login.php" class="btn btn-primary py-3 px-5">Login to Add to Cart</a>
...
<section class="ftco-section">
	<div class="container">
		...
		<div class="row">
			...
			<?php foreach ($allrelatedProduct as $allrelatedProduct) : ?>
				<div class="col-md-3">
					<div class="menu-entry">
						<a href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $allrelatedProduct->id; ?>" class="img" style="background-image: url(<?php echo IMAGEURL; ?>/<?php echo $allrelatedProduct->image; ?>);"></a>
