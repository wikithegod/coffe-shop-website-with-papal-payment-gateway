            ...
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span class="text">Down South ,Sri Lanka</span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span class="text">+94 41 2222 111</span></a></li>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                   ...
                   </script> All rights reserved <i class="icon-heart" aria-hidden="true"></i> Nimsara-->
                    Copyright &copy;<script>
                        document.write(new Date().getFullYear());
                    </script> Nimsara
                </p>
